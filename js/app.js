...
function select_item(select) {
	...
	if (select_type == 'input') {
		select_type_content = '<div class="select__value icon-select-arrow"><input autocomplete="off" type="text" name="form[]" value="' + select_selected_text + '" data-error="Помилка" data-value="' + select_selected_text + '" class="select__input"></div>';
	} else {
